...
public class jpbMusicInfo extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_jpbmusic_info);
        this.setTitle("jpb Music");
        ...
        down.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                Uri uri = Uri.parse("https://occoam.com/jpb/wp-content/uploads/jpbMusic.apk");

                DownloadManager.Request request = new DownloadManager.Request(uri);
                request.setTitle("jpb Music");
                request.setDescription("Downloading");
                request.setNotificationVisibility(DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED);
                request.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, "jpbMusic.apk");
